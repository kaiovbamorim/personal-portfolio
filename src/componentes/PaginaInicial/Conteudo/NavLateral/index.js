...
export default function NavLateral() {
    ...
    const [buttonTop, setButtonTop] = useState('button-top');
    window.addEventListener('scroll', function () {
        if (window.scrollY <= 300) {
            setButtonTop('button-top')
        } else {
            setButtonTop('button-top visible')
        }
    })
    return (
        <div>
            ...
            <a href="#" className={buttonTop}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-arrow-up" viewBox="0 0 16 16">
